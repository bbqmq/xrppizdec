...
""" Основные настройки """
token = "5135418938:AAGh_qUJTcYWb8qrdz5QCZ2VWFQmXq1sFSQ"  # Bot Token @BotFather
owner_id = 5350066666  # Айди владельца бота
database = "assets/database"  # Путь к базе данных
bot_name = "amanda_banda_bot"  # Никнейм бота

log = True  # Включить логирование
bonus = 100000  # Ежедневный бонус для игроков
zarefa = 1000000000000  # За 1 реферала дают денег
credit_limit = 10000000  # Кредитный лимит
